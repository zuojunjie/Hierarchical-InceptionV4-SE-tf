...
_ITEMS_TO_DESCRIPTIONS = {
    ...
    'label_1': 'The label id of the image, integer between 0 and 999',
    'label_2': 'The label id of the image, integer between 0 and 999',
    'label_3': 'The label id of the image, integer between 0 and 999',
    'label_4': 'The label id of the image, integer between 0 and 999',
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  keys_to_features = {
      ...
      'image/class/label_2': tf.FixedLenFeature(
          [], dtype=tf.int64, default_value=-1),
      'image/class/label_3': tf.FixedLenFeature(
          [], dtype=tf.int64, default_value=-1),
      'image/class/label_4': tf.FixedLenFeature(
          [], dtype=tf.int64, default_value=-1),
  ...
  items_to_handlers = {
      'image': slim.tfexample_decoder.Image('image/encoded', shape=[320,320,3]),
      'label_1': slim.tfexample_decoder.Tensor('image/class/label_1'),
      'label_2': slim.tfexample_decoder.Tensor('image/class/label_2'),
      'label_3': slim.tfexample_decoder.Tensor('image/class/label_3'),
      'label_4': slim.tfexample_decoder.Tensor('image/class/label_4'),      
